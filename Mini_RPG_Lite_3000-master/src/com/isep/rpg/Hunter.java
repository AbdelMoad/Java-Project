...
public class Hunter extends Hero{
    ...
    public void doAction(List<Combatant> enemies, List<Combatant> heros, int ixHero){
        ...
        while (true) {
            ...
            System.out.println("    (2) Se Nourrir (+5 Pts de Vie)");
    ...
    public void useArrow(){
        if (!arrows.isEmpty()){
            arrows.remove(0);
            System.out.println("Il reste"+(arrows.size()+1)+ " flèches");
        } else {
    ...
    public void chooseReward(){
        ...
        while (true) {
            ...
            System.out.println("    (3) Nourriture plus efficace (+♥2)");
            System.out.println("    (4) Plus de flèches (+5 flèches)");
